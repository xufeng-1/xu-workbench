...
(function () {
  ...
  const ICONS = {
    ...
    weather: '<path d="M17.5 13.2a3.6 3.6 0 0 0-.6-7.1 5 5 0 0 0-9.4 1.5A3.3 3.3 0 0 0 7.6 17h9.6a2.7 2.7 0 0 0 .3-3.8Z"/><path d="M12 7.5l1.2 3.2 3.2 1.2-3.2 1.2-1.2 3.2-1.2-3.2-3.2-1.2 3.2-1.2Z"/>',
    countdown: '<path d="M7 3.5h10M7 20.5h10M8.5 3.5v3.2L12 11l3.5-4.3V3.5M8.5 20.5v-3.2L12 13l3.5 4.3v3.2"/>',
    notes: '<rect x="5" y="3.5" width="14" height="17" rx="2.5"/><path d="M9 8.5h6M9 12h6M9 15.5h3.5"/>',
    sounds: '<path d="M3.5 10.5v3M7 7.5v9M10.5 5v14M14 7.5v9M17.5 10.5v3"/>',
