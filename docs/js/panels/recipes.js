...
(function () {
  ...
  XU.regPanel('recipes', async function (root) {
    ...
    el.addEventListener('click', (e) => {
      ...
      if (r.video) {
        html += '<p class="sub" style="margin-top:12px"><b>制作视频</b></p><div style="cursor:pointer" class="video-card" data-url="' + XU.esc(r.video.url || '') + '">' +
          ...
          '<span class="play-badge">' + XU.icon('play') + '</span></div>';
      }
      XU.modal(html);
    });
  });
